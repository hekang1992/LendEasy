...
#import "LendEasy_RefreshHeader.h"

@implementation LendEasy_RefreshHeader
+(instancetype)headerWithRefreshingBlock:(MJRefreshComponentAction)refreshingBlock{
    LendEasy_RefreshHeader *header =  [super headerWithRefreshingBlock:refreshingBlock];
...
@implementation LendEasy_RefreshFooter

+(instancetype)footerWithRefreshingBlock:(MJRefreshComponentAction)refreshingBlock{
    LendEasy_RefreshFooter *footer =  [super footerWithRefreshingBlock:refreshingBlock];
