...
static const CGFloat normalModulus = 0.1f;
static const CGFloat bufferModulus = 0.2f;
...
- (void)initCell {
    ...
    CGRect rect = [text boundingRectWithSize:CGSizeZero
                                  ...
                                  attributes:@{NSFontAttributeName:self.font?self.font:[UIFont boldSystemFontOfSize:40]}
                                     context:nil];
        ...
        for (NSInteger i = 0; i < repeatCountArray.count; i++) {
            ...
            if (repeatCount == 0) {
                ...
                if (direction == ScrollAnimationDirectionUp) {
                    ...
                    CGFloat cycleDuration = interval * 1 / fabs(changeNumber / pow(10, i));
                    if (repeatCount == 1) {
                        cycleDuration = 0;
                    }
